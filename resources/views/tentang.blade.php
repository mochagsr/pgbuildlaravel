...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
    ...
    <div class="flex flex-col md:flex-row gap-8 mb-14 items-start">
        <div class="md:w-72 shrink-0">
            <img src="{{ $setting->cover_url }}" alt="Pustaka Grafika"
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        ...
        <div class="aspect-square overflow-hidden rounded-xl shadow">
            <img src="{{ $img->url }}" alt="Kegiatan Pustaka Grafika"
                 class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
        </div>
        @endforeach
    </div>
    @else
    {{-- Fallback ke gambar lama jika belum ada di DB --}}
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        @foreach(['t2','t3','t4','t5','t6','t7','t8','t9','t10','t11','t12','t13'] as $img)
